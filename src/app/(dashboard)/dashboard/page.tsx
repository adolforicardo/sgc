...
function MetricCard({
  ...
  const content = (
    <Card className="flex items-start gap-3 hover:border-slate-300 transition-colors group">
      <div className="p-2 rounded-lg bg-gradient-to-br from-indigo-50 to-slate-50 text-indigo-600 group-hover:from-indigo-100 group-hover:to-slate-100 transition-colors">
        {icon}
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-xs font-medium text-slate-500">{title}</p>
        <p className="text-lg font-bold text-slate-900 mt-0.5 tracking-tight">{value}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <Card>
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-semibold text-slate-900">Candidaturas por Estado</h3>
            ...
            <Card>
              ...
              <div className="space-y-2">
                {metrics.recentActivity.map((item, i) => (
                  <div key={i} className="flex items-center justify-between py-2 px-3 rounded-md bg-slate-50/80 hover:bg-slate-100/80 transition-colors">
