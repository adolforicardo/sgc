...
export const mockApplications: Application[] = [
  {
    ...
    status: 'evaluating',
    documents: [
      { id: 'doc-1', name: 'CV_Pedro.pdf', type: 'application/pdf', url: '/mock/cv.pdf', uploadedAt: '2025-03-02T10:00:00Z' },
      { id: 'doc-2', name: 'Carta_Motivacao.pdf', type: 'application/pdf', url: '/mock/motivation.pdf', uploadedAt: '2025-03-02T10:05:00Z' },
    ],
    submittedAt: '2025-03-02T10:00:00Z',
    updatedAt: '2025-03-03T14:00:00Z',
    timeline: [
      { id: 'evt-1', type: 'status_change', description: 'Candidatura submetida', userId: 'user-4', createdAt: '2025-03-02T10:00:00Z' },
      { id: 'evt-2', type: 'status_change', description: 'Em triagem', userId: 'user-2', createdAt: '2025-03-02T14:00:00Z' },
      { id: 'evt-3', type: 'status_change', description: 'Em avaliação', userId: 'user-2', createdAt: '2025-03-03T09:00:00Z' },
    ],
  },
  {
    id: 'app-2',
    ...
    status: 'submitted',
    documents: [
      { id: 'doc-3', name: 'CV.pdf', type: 'application/pdf', url: '/mock/cv2.pdf', uploadedAt: '2025-03-03T09:00:00Z' },
    ],
    submittedAt: '2025-03-03T09:00:00Z',
    updatedAt: '2025-03-03T09:00:00Z',
    timeline: [
      { id: 'evt-4', type: 'status_change', description: 'Candidatura submetida', userId: 'user-4', createdAt: '2025-03-03T09:00:00Z' },
    ],
  },
  {
    id: 'app-3',
    ...
    status: 'screening',
    documents: [
      { id: 'doc-4', name: 'CV_Sofia.pdf', type: 'application/pdf', url: '/mock/cv3.pdf', uploadedAt: '2025-03-04T11:00:00Z' },
      { id: 'doc-5', name: 'Portfolio.pdf', type: 'application/pdf', url: '/mock/portfolio.pdf', uploadedAt: '2025-03-04T11:05:00Z' },
    ],
    submittedAt: '2025-03-04T11:00:00Z',
    updatedAt: '2025-03-04T14:00:00Z',
    timeline: [
      { id: 'evt-5', type: 'status_change', description: 'Candidatura submetida', userId: 'user-6', createdAt: '2025-03-04T11:00:00Z' },
      { id: 'evt-6', type: 'status_change', description: 'Em triagem', userId: 'user-2', createdAt: '2025-03-04T14:00:00Z' },
    ],
  },
  {
    id: 'app-4',
    ...
    status: 'submitted',
    documents: [
      { id: 'doc-6', name: 'CV_Ricardo.pdf', type: 'application/pdf', url: '/mock/cv4.pdf', uploadedAt: '2025-03-05T09:30:00Z' },
    ],
    submittedAt: '2025-03-05T09:30:00Z',
    updatedAt: '2025-03-05T09:30:00Z',
    timeline: [
      { id: 'evt-7', type: 'status_change', description: 'Candidatura submetida', userId: 'user-7', createdAt: '2025-03-05T09:30:00Z' },
    ],
  },
];
...
export const mockEvaluations: Evaluation[] = [
  {
    ...
    submittedAt: '2025-03-03T14:00:00Z',
  },
];
